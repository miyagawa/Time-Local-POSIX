...
use Config;
use Test::More 0.96;
use Time::Local::POSIX qw( timegm timelocal );
...
subtest(
    ...
    sub {
        ...
        is(
            timegm( 16, 36, 0, 20, 1, 36812 - 1900 ), 2**40,
        ...
        subtest(
            ...
            sub {
                ...
                is(
                    ...
                    $pre_break,
                    "year $pre_break is treated as 20th century",
                );
                is(
                    (
                    ...
                    $break,
                    "year $break is treated as 20th century",
                );
                is(
                    (
                        (
                    ...
                    $post_break,
                    "year $post_break is treated as 20th century",
                );
            }
        );
    },
